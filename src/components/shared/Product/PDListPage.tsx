import { ProductList } from '@/e-com/Context/Apis';
...
const PDListPage = () => {
  ...
  useEffect(() => {
    ...
    ProductList({ sortBy, sortType, query, page })
      .then((response: {}) => {
  ...
  if (ProductData) {
    ...
    return (
      <div
        className="selection:bg-red-300
    "
      >
          ...
          <div className="sm:max-w-[1200px] w-full bg-white  h-fit sm:p-[25px] lg:p-[80px]  sm:m-11 shadow-lg ">
            <div className="ml-3 my-7 mb-10 flex flex-col justify-center items-center cursor-pointer sm:items-start">
              <div className="flex justify-start items-center ">
                <Link
                  to="/"
                  className=" underline underline-offset-4 text-sm font-semibold text-gray-600 hover:text-red-300 "
                >
                  Home
                </Link>
              ...
              <div
                className=" w-[98%] flex sm:justify-between sm:flex-row
              ...
              >
                ...
                <div className="mt-5 sm:mt-1 flex flex-col ">
                  <input
                    type="text"
                    className=" border-2  border-slate-500 rounded-md mb-2 h-[35px ] w-[200px]  "
            ...
            <div className="h-[55px]  w-full flex  ">
              {/* <Pagination /> */}
              {[...Array(ProductData.meta.last_page)].map(
                (val: any, index: number) => {
                  ...
                  return (
                    <Link
                      to={
                        '?' +
                        new URLSearchParams({ ...params, page: String(pageNo) })
                      }
                      key={pageNo}
                      className={
