    ...
    return (
      <div className=" selection:text-white  selection:bg-red-300 flex  flex-col justify-start  items-center bg-gray-100 p-0  lg:px-10 sm:px-5  lg:pt-10   ">
            ...
            <div className="w-[460px] h-[370px] p-[10px]    ">
              <div className=" h-[26px] w-full text-sm text-slate-500 font-semibold  cursor-pointer  flex flex-wrap tracking-widest  ">
                <Link
                  to="/"
                  className="
        underline underline-offset-8 my-1 hover:text-red-500 "
                >
                  {' '}
                  HOME{' '}
                </Link>
        ...
        underline underline-offset-8 my-1 hover:text-red-500 "
              ...
              <div
                style={{ fontFamily: 'font-family:garamond,serif;' }}
                className=" mt-10 font-snas w-full text-4xl text-gray-800  font-semibold fontareal "
              >
                {title}{' '}
              </div>
              <div className="my-3 font-sans  text-2xl text-gray-900 font-semibold fontareal ">
                {' '}
                $ {price}{' '}
              </div>
              ...
              <div className=" w-full my-3 border-b-2 border-gray-100 py-7">
                <input
                  className="h-[37px] w-[55px] text-gray-500 border-2 border-gray-400 mr-2  text-center  "
                  type="number"
                  value={value}
                  onChange={handleQuantity}
                />
                <button
                  className="h-[38px] w-[180px] text-lg text-white font-semibold bg-red-500  rounded-sm shadow-md hover:shadow-2xl hover:scale-105    "
              ...
              <div className="  flex tracking-wider font-semibold ">
                ...
                <div className=" text-red-500 hover:text-red-900 ml-2 underline underline-offset-4 ">
                  {' '}
                  {category}{' '}
                </div>
              </div>
          ...
          <div className="h-[115px] w-full my-3 border-t-2 border-gray-200   ">
            <div className=" text-2xl mb-3 font-semibold text-gray-700 mt-3  ">
              {' '}
              Description
            </div>
          ...
          {RelatedData && (
            <div className=" h-fit w-full  ">
              <div className="text-[25px] text-gray-600 font-semibold ">
                {' '}
                Related Products{' '}
              </div>
